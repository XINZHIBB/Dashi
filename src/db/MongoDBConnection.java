...
public class MongoDBConnection implements DBConnection {
	...
	public void setVisitedRestaurants(String userId, List<String> businessIds) {
		// user_id : 1111
		// visited : ['vaso', 'la-petit']
		// sql = where user_id ....
		db.getCollection("users").updateOne(new Document("user_id", userId),
				new Document("$pushAll", new Document("visited", businessIds))); // $pushAll -> append 
	}
	...
	public void unsetVisitedRestaurants(String userId, List<String> businessIds) {
		...
		// visited : ['la-petit']
		// sql = where user_id ....
		db.getCollection("users").updateOne(new Document("user_id", userId), // conditino
																				// if
																				// user_id
																				// ==
																				// userId
	 ...
	 * public JSONArray recommendRestaurants() { //implementation } }
	 * 
	 * MySQLDBConnection extends DBConnectionImpl 
	 * MongoDBConnection extends DBConnectionImpl
	 * 
	 * 
	 */
